...
st.sidebar.title("Nodo + Ciencias")
st.sidebar.divider()
st.sidebar.markdown("Mentor De Ciencias", unsafe_allow_html=True)
st.sidebar.markdown("hacer Agent Toolkit 1.0")
st.sidebar.divider()

st.write("""<img height="120" src="https://es.nodoeafit.com/wp-content/uploads/2024/11/CIENCIAS-EXACTAS.png"/>""", unsafe_allow_html=True)
